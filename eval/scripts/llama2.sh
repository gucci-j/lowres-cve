...
model_identifier="Llama-2-7b-hf"
source_model_name="meta-llama/Llama-2-7b-hf"
model_abbrev="llama2"
...
for lang_code in "${lang_codes[@]}"; do
    model_paths=(
        ...
        "${model_base_dir}/${model_identifier}-${lang_code}-30K-merge-tuned"
        "${model_base_dir}/${model_identifier}-${lang_code}-30K-focus-tuned"
    )
